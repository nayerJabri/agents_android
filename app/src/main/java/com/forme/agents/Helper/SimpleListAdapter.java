...
public class SimpleListAdapter extends BaseAdapter implements Filterable, ISpinnerSelectedView {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            TextView dispalyName = (TextView) view.findViewById(android.R.id.text1);
            dispalyName.setText(mStrings.get(position-1));
            dispalyName.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_END);
        }
        return view;
    }
    ...
    public View getNoSelectionView() {
        View view = View.inflate(mContext, android.R.layout.simple_spinner_dropdown_item, null);
        return view;
    }
