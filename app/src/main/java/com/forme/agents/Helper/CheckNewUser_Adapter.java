...
public class CheckNewUser_Adapter extends RecyclerView.Adapter<CheckNewUser_Adapter.ViewHolder>{
    ...
    public CheckNewUser_Adapter(Context context, ArrayList<CheckNewUser> list, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.allowuser_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView name, local,mobile;
        ...
        public void bind(CheckNewUser cbecknewuser, CheckNewUser_Adapter.OnItemClickListener listener) {
